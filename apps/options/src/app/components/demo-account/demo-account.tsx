  ...
  return (
    <div className="trading-experience bg-woodsmoke sm:pl-40 rounded-2xl relative flex xs:flex-col lg:flex:row xs:items-center sm:items-start xs:justify-start lg:items-start lg:justify-start">
      <div className="flex flex-col justify-between pb-20">
        <p className="experience-title text-40 font-InterLight md:font-InterRegular text-primary xs:w-full sm:w-385 pt-40 leading-8">
          Free demo account
        </p>
        ...
        <Link to="/trade">
          <ArrowIcon
            ...
            revert={true}
            status={"up"}
            className="[&>p]:font-OcrExtendedRegular [&>p]:text-15"
          />
        </Link>
      </div>
